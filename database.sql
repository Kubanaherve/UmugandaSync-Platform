...
-- ------------------------------------------------------------
-- Table: admins
-- Who can log into the system (Village Leader / secretary)
-- ------------------------------------------------------------
CREATE TABLE admins (
...
-- ------------------------------------------------------------
-- Table: members
-- Community people who participate in Umuganda
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Table: attendance
-- One row = one member on one Umuganda date
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Table: projects
-- Community work projects (roads, cleaning, etc.)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Table: tools
-- Shared community tool inventory
-- ------------------------------------------------------------
CREATE TABLE tools (
...
-- ------------------------------------------------------------
-- Table: tool_borrows
-- History of who borrowed / returned which tool
-- ------------------------------------------------------------
...
-- Attendance on official Umuganda days = LAST Saturday of each month
